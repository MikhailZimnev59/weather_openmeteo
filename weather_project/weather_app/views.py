...
WC = {0: 'Ясное небо',                      1: 'В основном ясно', 2: 'Переменная облачность',
      3: 'Пасмурно',    45: 'Туман',
      48: 'Иней или иней на земле',         51: 'Лёгкая морось',53: 'Умеренная морось',
      55: 'Сильная морось',   56: 'Морось + замерзающая (лёгкая)',
      57: 'Морось + замерзающая (сильная)', 61: 'Лёгкий дождь', 63: 'Умеренный дождь',
      65: 'Сильный дождь',    66: 'Дождь + замерзающий (лёгкий)',
      67: 'Дождь + замерзающий (сильный)',  71: 'Лёгкий снег',  73: 'Умеренный снег',
      75: 'Сильный снег',     77: 'Град',
      80: 'Ливень — лёгкий',                81: 'Ливень — умеренный',
      82: 'Ливень — сильный', 85: 'Ливень со снегом — лёгкий',
      86: 'Ливень со снегом — сильный',     95: 'Гроза (обычная или слабая)',
      96: 'Гроза + лёгкий град', 99: 'Гроза + сильный град'}
